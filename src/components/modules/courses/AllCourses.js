    ...
    return (
        <div>
            <div className='2xl:flex 2xl:justify-center xl:flex lg:flex xl:justify-center lg:justify-center'>
                <p className='font-Poppins 2xl:w-2/4 xl:w-2/3 lg:w-2/3 ml-5 mt-0 mb-0'>All course</p>
            </div>
            <div className='2xl:justify-center 2xl:flex xl:justify-center xl:flex lg:justify-center lg:flex'>
                <div className='
                        2xl:justify-center 2xl:grid 2xl:grid-cols-3 2xl:w-2/4 xl:w-2/4 lg:w-2/3
                        xl:justify-center lg:justify-center
                        xl:grid xl:grid-cols-3 lg:grid lg:grid-cols-3 xl:mr-4 lg:mr-4'>
                    {
                        allCourses.map(course => {
                            return (
                                <div
                                    ...
                                    className=
                                    {
                                    `mt-4 shadow-lg border-gray-200 border-2 ml-4 
                                    mr-4 rounded-xl overflow-y-scroll
                                    2xl:overflow-auto`
                                    }
                                >
                                    <div className='grid sm:grid-cols-2 xsm:grid-cols-2 md:grid-cols-2 pt-2 pb-3 pl-2 2xl:flex 2xl:flex-col 2xl:pr-2 xl:pr-2 lg:pr-2'>
